...
def load_data():
    ...
    - Searches for the file in two locations relative to this file
    ...
    # Search for likely Excel files in app dir and project root
    candidates = []
    ...
    if excel_path is None:
        st.error(
            ...
            "Place it in the project root or alongside this app file."
        )
        st.stop()
